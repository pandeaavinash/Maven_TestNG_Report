package com.facebook.confighandler;
...
public class LoadProperties 
{
	...
	{
		System.out.println(LoadProperties.REGISTER_FIRSTNAMETXT);
		System.out.println(LoadProperties.REGISTER_MOBILENOTXT);
		System.out.println(LoadProperties.LOGIN_PASSWORDTXT);
	}
}

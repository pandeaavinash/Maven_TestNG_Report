package com.facebook.emailutility;
...
public class EmailSend 
{
	...
	public static void sendEmail(String fromEmail, String toEmail,File file)
	{
	    ...
	    properties.setProperty("mail.smtp.password", "Avishka31032020");
	    ...
	    Session session = Session.getDefaultInstance(properties, new javax.mail.Authenticator() 
	    {
	        ...
	        {
	            return new PasswordAuthentication("aavinashpande@gmail.com","Avishka31032020");
	        }
	   });
	    ...
	    try{
	       ...
	       transport.connect(null, "aavinashpande@gmail.com","Avishka31032020");
	       // Send message
